...
CREATE TABLE `tipo_entidad` (
  `id_tipo_entidad` bigint NOT NULL AUTO_INCREMENT,
...
INSERT INTO `tipo_entidad` VALUES (1,'Institución Educativa'),(2,'Centro Médico'),(3,'Centro Comercial'),(4,'Punto de Control'),(5,'Restaurante'),(6,'Parque');
